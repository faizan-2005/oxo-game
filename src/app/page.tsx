            ...
            <div className="relative w-full max-w-[300px] flex flex-col items-center gap-6">
              ...
              <div className="w-full flex flex-col gap-3">
                ...
                <a href="https://github.com/faizan-2005/oxo-game" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-3 rounded-full bg-slate-900 text-white">
                  <span className="font-bold text-sm flex items-center gap-2"><svg viewBox="0 0 16 16" className="w-4 h-4 fill-white shrink-0"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82a7.42 7.42 0 0 1 4 0c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0 0 16 8c0-4.42-3.58-8-8-8z"/></svg> Star this repo</span>
        ...
        {showSettings && (
          <div className="absolute inset-0 z-40 bg-white flex flex-col items-center justify-center p-6">
            ...
            <div className="relative w-full max-w-[300px] flex flex-col items-center gap-6">
              ...
              <div className="w-full flex flex-col gap-3">
                <button onClick={() => setMuted((m) => !m)} className="w-full flex items-center justify-between p-3 rounded-full border-2 bg-[#e0f7fa] border-[#00bcd4]/30">
